...
class AuthController {
  ...
  async resend({ request, response, session }) {
    ...
    if (!user) {
      session.flash({
        flash_info:
          "If the email you entered was right, in a minute you will receive the link to confirm your account.",
      });
  ...
  async forgot({ request, response, session }) {
    ...
    if (!user) {
      session.flash({
        flash_error:
          "If the email you entered was right, in a minute you will receive the link to reset the password.",
      });
      return response.redirect("back");
    }
